...
A zen garden-inspired blog built with Next.js 16, Tailwind CSS, shadcn/ui, and  serverless . Think floating lanterns, particle drift, and subtle easter eggs reminiscent of Genshin Impact promo sites.

## Features

- Markdown-powered journal stored in `content/journal/*.md`
- Guestbook with   storage + token-protected admin moderation
