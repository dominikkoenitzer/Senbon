...
excerpt: "Mapping the rhythm between rain chains, tsukubai bowls, and a moderation queue that approves entries by moon phase."
...
1. **Neon pulse** — serverless PostgreSQL idles quietly until a message arrives, then wakes with a shimmer. The SQL layer stores IP charcoal sketches for rate-limiting without being intrusive.
...
- The interface displays name, message, and timestamp
