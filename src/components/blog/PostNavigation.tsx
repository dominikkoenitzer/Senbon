...
const PostNavigation = ({ newer, older }: Props) => {
  ...
  return (
    <nav
      ...
      className="mt-16 grid gap-4 border-t border-border pt-10 sm:grid-cols-2 md:mt-24 md:gap-6 md:pt-14"
    >
      {newer ? (
        <Link
        ...
        >
          <span className="inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.3em] text-foreground/70">
