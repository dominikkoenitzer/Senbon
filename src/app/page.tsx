          ...
          <div className="zen-card px-8 py-6 backdrop-blur-sm bg-black/15 border-white/5">
            <div className="space-y-4 text-sm text-zen-mist/50">
              ...
              <div className="space-y-2 text-xs leading-relaxed">
                ...
                <p>
                  • Guestbook uses  serverless  via <code className="rounded bg-white/5 px-1.5 py-0.5 text-zen-gold/60">lib/db.ts</code>, hitting <code className="rounded bg-white/5 px-1.5 py-0.5 text-zen-gold/60">/api/guestbook</code>.
                </p>
                <p>
              ...
              <div className="pt-4 border-t border-white/5 mt-4">
                ...
                <ol className="space-y-2 list-decimal list-inside text-xs leading-relaxed">
                  ...
                  <li>Create a  project + table (schema provided below).</li>
